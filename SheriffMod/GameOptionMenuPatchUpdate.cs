...
namespace SheriffMod
{
	...
	{
		public static BCLDBBKFJPK permOn;
		...
		public static void Postfix(PHCKLDDNJNP __instance)
		{
			...
			GameOptionMenuPatchUpdate.permOn.transform.position = bcldbbkfjpk.transform.position - new Vector3(0f, 5.5f, 0f);
			GameOptionMenuPatchUpdate.sheriffCount.transform.position = GameOptionMenuPatchUpdate.permOn.transform.position - new Vector3(0f, 0.5f, 0f);
			GameOptionMenuPatchUpdate.sheriffCooldown.transform.position = GameOptionMenuPatchUpdate.sheriffCount.transform.position - new Vector3(0f, 0.25f, 0f);
			GameOptionMenuPatchUpdate.showSheriff.transform.position = GameOptionMenuPatchUpdate.showSheriff.transform.position - new Vector3(0f, 0.5f, 0f);
